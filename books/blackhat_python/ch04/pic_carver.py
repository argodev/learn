...
pictures_directory = '/home/ru7/pic_carver/pictures'
faces_directory = '/home/ru7/pic_carver/faces'
...
def face_detect(path, file_name):
    ...
    cv2.imwrite('%s/%s-%s' % (face_directory, pcap_file, file_name), img)
...
def http_assembler(pcap_file):
    ...
    for session in sessions:
        ...
        if image is not None and image_type is not Noe:
            # store the image
